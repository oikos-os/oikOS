...
**Goal:** Build the token-efficiency layer that sits between KAIROS and all tool interactions — observation masking, tool result compression, token budget tracking, and ReWOO planning.
