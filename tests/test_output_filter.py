...
# ---------------------------------------------------------------------------
# Test 1: CLEAN pass — normal oikOS tactical response
# ---------------------------------------------------------------------------

def test_clean_normal_response():
    """Normal tactical oikOS response passes without modification."""
    response = (
...
def test_false_positive_phase_keyword_is_clean():
    """The word 'phase' is common oikOS vocabulary and must NOT trigger anything."""
    response = (
