...
def test_vault_lookup_triggered_and_returned():
    ...
    mock_chunk = {"source_path": "vault/identity/GOALS.md", "content": "Location: Herndon, VA"}
...
def test_handler_step_8a_fires(tmp_path):
    ...
    with (
        ...
        patch("core.cognition.pipeline.context.compile_context", return_value=MagicMock(
        ...
        patch("core.cognition.pipeline.postprocess.score_response", return_value=MagicMock(
