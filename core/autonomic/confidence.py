...
VAULT_ENTITY_PHRASES = [
    "example project", "example novel", "apricot", "acme corp", 
    "problem", "secrets of the soil", "horas de ócio", 
    "vantablack", "oikos", "kairos", "gemini", "claude", "user",
    "example_artist_3", "springfield", "springfield", "example_artist", "jocasta", "oedipus",
]
