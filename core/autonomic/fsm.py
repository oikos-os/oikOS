...
VALID_TRANSITIONS: dict[SystemState, set[SystemState]] = {
    ...
    SystemState.ASLEEP: {SystemState.ACTIVE, SystemState.IDLE},
}
...
def transition_to(target: SystemState, trigger: str = "manual") -> dict:
    ...
    try:
        ...
        # T-119: dedicated idle_cascade event for notifications (SHOULD tier)
    ...
    if cb:
        try:
            ...
            callback_result = {"callback_error": f"{target.value} callback failed (see logs)"}
...
def _on_enter_idle() -> dict:
    ...
    try:
        ...
        result["reindex_error"] = "State transition error"
    ...
    try:
        ...
        result["consolidation_error"] = "State transition error"
    ...
    try:
        ...
        result["scanner_error"] = "State transition error"
...
def _auto_commit_vault() -> dict:
    ...
    try:
        ...
        return {"committed": False, "error": "State transition error"}
