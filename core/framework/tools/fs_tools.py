...
@oikos_tool(
    ...
    concurrent_safe=True,
    read_only=True,
    search_hint="list directory contents files folders browse",
    group="filesystem",
)
...
@oikos_tool(
    ...
    concurrent_safe=True,
    read_only=True,
    search_hint="search find files pattern glob name match",
    group="filesystem",
)
...
@oikos_tool(
    ...
    toolset="file",
    search_hint="write create file save content output",
    group="filesystem",
)
...
@oikos_tool(
    ...
    autonomy=AutonomyLevel.ASK_FIRST,
    toolset="file",
    search_hint="edit modify replace patch update file text",
    group="filesystem",
)
...
@oikos_tool(
    ...
    toolset="file",
    destructive=True,
    search_hint="move rename relocate file transfer",
    group="filesystem",
)
...
@oikos_tool(
    ...
    autonomy=AutonomyLevel.ASK_FIRST,
    toolset="file",
    search_hint="copy duplicate clone file backup",
    group="filesystem",
)
