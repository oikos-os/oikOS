...
@oikos_tool(
    ...
    toolset="research",
    search_hint="research queue topics manage add remove list",
    group="research",
)
...
@oikos_tool(
    ...
    toolset="research",
    search_hint="research run execute cycle search summarize",
    group="research",
)
...
@oikos_tool(
    ...
    read_only=True,
    search_hint="research review staged results pending",
    group="research",
)
...
@oikos_tool(
    ...
    autonomy=AutonomyLevel.ASK_FIRST,
    toolset="research",
    search_hint="research approve promote vault accept",
    group="research",
)
...
@oikos_tool(
    ...
    toolset="research",
    destructive=True,
    search_hint="research reject delete remove staged discard",
    group="research",
)
