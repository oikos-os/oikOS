...
@oikos_tool(
    ...
    concurrent_safe=True,
    read_only=True,
    search_hint="compile context window token budget assemble",
    group="knowledge",
)
...
@oikos_tool(
    ...
    toolset="vault",
    search_hint="rebuild reindex vault search index embeddings",
    group="knowledge",
)
...
@oikos_tool(
    ...
    autonomy=AutonomyLevel.ASK_FIRST,
    toolset="vault",
    search_hint="add import file vault ingest content",
    group="knowledge",
)
...
@oikos_tool(
    ...
    concurrent_safe=True,
    read_only=True,
    search_hint="vault health metrics statistics coverage stale",
    group="knowledge",
)
