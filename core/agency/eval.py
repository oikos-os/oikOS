...
Cross-model validation: 7B judges 14B output.
...
EVAL_QUERIES: list[dict] = [
    ...
    {
        "eval_id": "E-02",
        "query": "What are ARCHITECT's active goals?",
        "expected_tier": "core",
    },
    {
        "eval_id": "E-03",
    ...
    {
        "eval_id": "E-19",
        "query": "What were the key milestones in the project timeline?",
        "expected_tier": "episodic",
    },
    {
        "eval_id": "E-20",
...
def run_eval(
    ...
    try:
        ...
        log.debug("eval_start emit_event suppressed: %s", e)
    ...
    try:
        ...
        log.debug("eval_complete emit_event suppressed: %s", e)
