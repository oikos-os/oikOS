...
_PII_WHITELIST = {
    # Project names
    "trendy decay", "arcadia heights", "apricot", "aegis", "oikos", "oikos omega",

    # Artist/character aliases
    "rulez", "vossa", "boy", "lunarios", "k.p. glass", "kp glass",
    "jocasta", "oedipus", "cassandra", "elena", "veronica thorne",

    # Track/release names
    "problem", "secrets", "horas", "lovebyte",

    # Organizations
    "frontpoint", "trendy decay llc",
