...
DOCTRINE_QUOTES = [
    ...
    ("The cloud is a loan.", "Your memory outlives the model."),
    ("Fix the soul", "before building the hands."),
    ("Even agents", "need a home."),
]
...
def _system_panel(
    ...
    quote = random.choice(DOCTRINE_QUOTES)
    quote_lines = [f"  [oikos.system]{line}[/]" for line in quote if line]
