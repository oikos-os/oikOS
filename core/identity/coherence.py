...
_IDENTITY_MARKERS = {
    # System names
    "oikos", "omega", "engineer",

    # Core concepts
    "architect", "vessel", "vault", "standing by", "monitoring",

    # Domain indicators
    "local-first", "sovereign", "inference", "context",
}
...
def check_coherence(response: str) -> CoherenceResult:
    """
