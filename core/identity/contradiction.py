...
def check_contradiction(
    ...
    try:
        ...
        return ContradictionResult(
            ...
            contradiction_type="none",
            confidence=0.0,
            explanation="NLI response not valid JSON",
        )
    except Exception as e:
        log.error("NLI contradiction check skipped — cloud unavailable: %s", e)
        return ContradictionResult(
            has_contradiction=False,
            contradiction_type="none",
            confidence=0.0,
            explanation="NLI check skipped: cloud inference unavailable",
        )
