...
function AppMain() {
  ...
  useEffect(() => {
    try {
      ...
      document.documentElement.style.setProperty("--scanline-opacity", enabled ? "0.03" : "0");
  ...
  return (
    <div className="oikos-screen h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-screen min-w-0 overflow-hidden">
        <Header state={state} wsConnected={connected} activeModel={chatState.activeModel} onThemeToggle={toggleTheme} theme={theme} activeRoom={activeRoom} onRoomSwitch={handleRoomSwitch} />
