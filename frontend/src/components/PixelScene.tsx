...
export default function PixelScene({ heartbeat, events }: Props) {
  ...
  return (
    <div
      className="relative bg-[var(--bg-secondary)] overflow-hidden mx-auto mt-8"
    ...
    >
      ...
      >
        ...
        {speechVisible && speech && (
          <div
            className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 whitespace-nowrap bg-[var(--bg-elevated)] px-2 py-1 text-xs text-white shadow-lg"
