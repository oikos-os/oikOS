...
export default function RoomManager() {
  ...
  return (
    <main className="flex-1 overflow-y-auto p-6 max-w-3xl mx-auto w-full">
      ...
      {creating && (
        <div className="mb-6 p-4 bg-[var(--bg-secondary)] border border-neutral-800">
      ...
      <div className="space-y-2">
        {rooms.map(r => (
          <div key={r.id} className={`flex items-center gap-4 p-3 border transition-colors ${r.id === active ? "border-[var(--accent)]/30 bg-[var(--bg-elevated)]" : "border-neutral-800 bg-[var(--bg-secondary)]"}`}>
