...
export default function CharacterSheet() {
  ...
  if (!data) {
    return (
      <div className="bg-[var(--bg-elevated)] p-4 text-neutral-600 text-sm">
  ...
  return (
    <section className="bg-[var(--bg-elevated)] p-4" data-testid="character-sheet">
      ...
      <div className="mb-4">
        ...
        <div className="h-2 bg-neutral-700/50 w-full">
          <div
      ...
      <div className="space-y-2 mb-4">
        {Object.entries(data.stats).map(([key, value]) => (
          <div key={key}>
            ...
            <div className="h-1.5 bg-neutral-700/50 w-full">
              <div
