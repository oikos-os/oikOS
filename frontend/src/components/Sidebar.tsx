...
import { IconMenu, IconPlus, IconSearch, IconDashboard, IconScene, IconWorkflow, IconAgents, IconSettings, IconStar, IconStarFilled } from "./icons";

export type Page = "dashboard" | "chat" | "scene" | "search" | "workflows" | "agents" | "settings";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center h-12 px-3 gap-2">
        ...
        <button
          onClick={onNewChat}
          className={`text-sm font-bold tracking-widest text-white whitespace-nowrap overflow-hidden transition-opacity duration-200 hover:text-amber-400 ${collapsed ? "opacity-0 w-0" : "opacity-100"}`}
          title="New Chat"
        >
          oikOS
        </button>
